...
describe('Triangle', () => {
    describe('render', () => {
        it('should retrun an svg image', () => {
            ...
            const expectedSvg = `<svg width="300" height="200"> <polygon points="50,0 0,100 100,100" fill="red" /> 
...
describe('Square', () => {
    describe('render', () => {
        it('should retrun an svg image', () => {
            ...
            const expectedSvg = `<svg width="300" height="200"> <rect x="10" y="10" width="80" height="80" fill="red" />
...
describe('Circle', () => {
    describe('render', () => {
        it('should retrun an svg image', () => {
            ...
            const expectedSvg = `<svg width="300" height="200"> <circle cx="50" cy="50" r="40" fill="red" />
<text x="50" y="60" fill="black" 
font-size="30" text-anchor="middle">Sample Text</text>
</svg>`
